!(function (t, e) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        ? define(["d3"], e)
        : ((t = "undefined" != typeof globalThis ? globalThis : t || self).f3 = e(t.f3));
})(this, function (t) {
    "use strict";
    function e(t) {
    ...
    function a(t, e, n) {
        if (((t.exiting = n), e))
            0 !== t.depth || t.spouse ? (t.spouse ? ((t._x = t.spouse.x), (t._y = t.spouse.y)) : t.is_ancestry ? ((t._x = t.parent.x), (t._y = t.parent.y)) : ((t._x = t.psx), (t._y = t.psy))) : ((t._x = t.x), (t._y = t.y));
        else if (n) {
            const e = t.x > 0 ? 1 : -1,
                n = t.y > 0 ? 1 : -1;
    ...
    function p({ datum: t, new_rel_datum: e, data_stash: n }) {
        ...
        if ((delete e._new_rel_data, (e = JSON.parse(JSON.stringify(e))), "son" === r || "daughter" === r)) {
            ...
            if (((t.rels.father = e.id), (e.rels = { children: [t.id] }), t.rels.mother)) {
                e.rels.spouses = [t.rels.mother];
                const r = n.find((e) => e.id === t.rels.mother);
                r.rels.spouses || (r.rels.spouses = []), r.rels.spouses.push(e.id);
            }
        } else if ("mother" === r && ((t.rels.mother = e.id), (e.rels = { children: [t.id] }), t.rels.father)) {
    ...
    function f({ data: t, rels: e }) {
        return {
            id:
                ((n = new Date().getTime()),
                (r = (performance && performance.now && 1e3 * performance.now()) || 0),
    ...
    function v({ data: t, main_id: e = null, node_separation: n = 250, level_separation: a = 150, single_parent_empty_card: s = !0, is_horizontal: o = !1 }) {
        if (!t || !t.length) return { data: [], data_stash: [], dim: { width: 0, height: 0 }, main_id: null };
        o && ([n, a] = [a, n]);
        const d = s
            ? (function (t) {
                  const e = [];
                  ...
                  function n(t) {
                      const n = f({ data: { gender: "M" === t.data.gender ? "F" : "M" }, rels: { spouses: [t.id], children: [] } });
                    ...
                    if (!r.is_ancestry && r.data.rels.spouses && r.data.rels.spouses.length > 0) {
                        ...
                        (r.x += (r.data.rels.spouses.length / 2) * e * n),
                            r.data.rels.spouses.forEach((i, a) => {
                                const s = { data: d.find((t) => t.id === i), added: !0 };
                                (s.x = r.x - e * (a + 1) * n),
                                    (s.y = r.y),
        ...
        const m = (function (t, e, n) {
            ...
            const i = r.extent(t, (t) => t.x),
                a = r.extent(t, (t) => t.y);
            return { width: i[1] - i[0] + e, height: a[1] - a[0] + n, x_off: -i[0] + e / 2, y_off: -a[0] + n / 2 };
        })(u, n, a);
        return { data: u, data_stash: d, dim: m, main_id: l.id, is_horizontal: o };
        function y(t, e, i) {
            const s =
                    "children" === e
                        ? function (t) {
                    ...
                    .separation(function (t, e) {
                        ...
                        i ||
                            ...
                            (function (t, e) {
                                ...
                                (n += (function (t, e) {
                                    return 0.5 * ((t.data.rels.spouses || []).length + (e.data.rels.spouses || []).length);
                                })(t, e)),
                            c(t, e) &&
                                !(function (t, e) {
    ...
    function b({ svg: t, svg_dim: e, tree_dim: n, with_transition: r, transition_time: i }) {
        x({ t: C(e, n), svg: t, with_transition: r, transition_time: i });
    }
    function C(t, e) {
        let n = Math.min(t.width / e.width, t.height / e.height);
        n > 1 && (n = 1);
        return { k: n, x: e.x_off + (t.width - e.width * n) / n / 2, y: e.y_off + (t.height - e.height * n) / n / 2 };
    }
    function w({ datum: t, svg: e, svg_dim: n, scale: r, transition_time: i }) {
        const a = r || 1;
        x({ t: { k: a, x: (n.width / 2 - t.x * a) / a, y: (n.height / 2 - t.y) / a }, svg: e, with_transition: !0, transition_time: i });
    }
    function $({ d: t, tree: e, is_horizontal: n = !1 }) {
        ...
        return (
            ...
            (function ({ d: t }) {
                ...
                r.push({ d: s(t, a), _d: () => s({ x: t.x, y: t.y }, { x: t.x, y: t.y }), curve: !0, id: o(t, e, n), depth: t.depth + 1, is_ancestry: !0, source: t, target: [e, n] });
            })({ d: t }),
            (function ({ d: t }) {
                ...
                t.children.forEach((i, l) => {
                    ...
                    r.push({ d: s(i, u), _d: () => s(u, { x: a(u, "x"), y: a(u, "y") }), curve: !0, id: o(i, t, c), depth: t.depth + 1, is_ancestry: !1, source: [t, c], target: i });
                });
            })({ d: t }),
            r
        );
    ...
    function T(t, { d: e }) {
        (e.data.hide_rels = !e.data.hide_rels), s(e, e.data.hide_rels), t.updateTree({ tree_position: t.state.tree_fit_on_change });
    }
    function E() {
    ...
    var it = Object.freeze({
        ...
        addNewPersonAndHandleRels: function ({ datum: t, data_stash: e, rel_type: n, rel_datum: r }) {
            m({ data_stash: e, datum: t }), u({ datum: t, data_stash: e, rel_type: n, rel_datum: r });
        },
        checkIfRelativesConnectedWithoutPerson: o,
        createForm: function ({ datum: t, store: e, fields: n, postSubmit: r, addRelative: i, deletePerson: a, onCancel: s, editFirst: d }) {
            const l = {
                fields: [],
                onSubmit: function (e) {
                    e.preventDefault();
            ...
            return (
                t._new_rel_data ||
                    ...
                    (l.editable = !1)),
                t._new_rel_data && ((l.title = t._new_rel_data.label), (l.new_rel = !0), (l.editable = !0), (l.onCancel = s)),
                ...
                n.forEach((e) => {
                    const n = { id: e.id, type: e.type, label: e.label, initial_value: t.data[e.id] };
                    l.fields.push(n);
                }),
                l
            );
    ...
    const ot = {
        miniTree: function (t, e) {
            ...
            return (
                i.on("click", function (n) {
                    n.stopPropagation(), e.onMiniTreeClick ? e.onMiniTreeClick.call(this, n, t) : H(e.store, { d: t });
                }),
                i.node()
            );
        },
            ...
            const n = e.card_dim,
                i = r.create("svg:g").html(
                    (function ({ d: t, card_dim: e }) {
                        ...
                        if (((t.is_ancestry || t.data.main) && (s(r) || s(i)) && (n += st({ x: e.w / 2, y: 0, rt: -45, closed: a }).template), !t.is_ancestry && t.added)) {
                            const s = t.spouse,
                                d = s.data.rels,
                                l = s.data._rels || {};
                            (o(r) || o(i)) && (o(d) || o(l)) && (n += st({ x: t.sx - t.x + e.w / 2 + 24.4, y: (t.x !== t.sx ? e.h / 2 : e.h) + 1, rt: 135, closed: a }).template);
                        }
                        return { template: n };
                    })({ d: t, card_dim: n }).template
                );
                      ...
                      (function ({ d: t, card_dim: e, card_add: n, label: r }) {
                          return {
                              template: `\n    <g class="card-body ${n ? "card_add" : "card-unknown"}">\n      <rect class="card-body-rect" width="${e.w}" height="${e.h}" fill="rgb(59, 85, 96)" />\n      <text transform="translate(${
                                  e.w / 2
                              }, ${e.h / 2})" text-anchor="middle" fill="#fff">\n        <tspan font-size="18" dy="8">${r}</tspan>\n      </text>\n    </g>\n  `,
                          };
                      })({ d: t, card_dim: i, card_add: e.cardEditForm, label: n }).template
                  )),
                  a.on("click", (n) => {
                      n.stopPropagation(), D(e.store, { d: t, cardEditForm: e.cardEditForm });
                  }))
                : ((a = r.create("svg:g").html(
                      ...
                      })({ d: t, card_dim: i, card_display: e.card_display }).template
                  )),
                  a.on("click", function (n) {
                      n.stopPropagation(), e.onCardClick ? e.onCardClick.call(this, n, t) : H(e.store, { d: t });
                  }));
            return a.node();
        },
        cardImage: function (t, e) {
            ...
            return r
                .create("svg:g")
                .html(
                    (function ({ d: t, image: e, card_dim: n, maleIcon: r, femaleIcon: i }) {
                        return {
                    ...
                    })({ d: t, image: t.data.data.avatar || null, card_dim: n, maleIcon: null, femaleIcon: null }).template
                )
                .node();
        },
    ...
    var ct = Object.freeze({
        ...
        Card: function (t) {
            return (
                lt(
                    (t = (function (t) {
                        const e = { img: !0, mini_tree: !0, link_break: !1, card_dim: { w: 220, h: 70, text_x: 75, text_y: 15, img_w: 60, img_h: 60, img_x: 5, img_y: 5 } };
                        t || (t = {});
                ...
                function (e) {
                    const n = "M" === e.data.data.gender ? "card-male" : "F" === e.data.data.gender ? "card-female" : "card-genderless",
                        ...
                        a = r
                            .create("svg:g")
                            .attr("class", `card ${n}`)
                            .attr("transform", `translate(${[-i.w / 2, -i.h / 2]})`);
                    a.append("g").attr("class", "card-inner").attr("clip-path", "url(#card_clip)"),
                        (this.innerHTML = ""),
                        ...
                        (function (t, e, n) {
                            ...
                            })({ d: e, card_dim: i, is_new: e.data.to_add }).template,
                            a.node(),
                            !0
                        ),
                        dt(ot.cardBody(e, t), this.querySelector(".card-inner")),
                        t.img && dt(ot.cardImage(e, t), this.querySelector(".card")),
                        t.mini_tree && dt(ot.miniTree(e, t), this.querySelector(".card"), !0),
                        t.link_break && dt(ot.lineBreak(e, t), this.querySelector(".card")),
                        t.cardEditForm && (dt(ot.cardEdit(e, t), this.querySelector(".card-inner")), dt(ot.cardAdd(e, t), this.querySelector(".card-inner"))),
                        t.onCardUpdates && t.onCardUpdates.map((t) => t.call(this, e)),
        ...
        CardHtml: function (t) {
            ...
            return function (n) {
                (this.innerHTML = `\n    <div class="card ${(function (t) {
                    const e = [];
                    "M" === t.data.data.gender ? e.push("card-male") : "F" === t.data.data.gender ? e.push("card-female") : e.push("card-genderless");
                    t.data.main && e.push("card-main");
                    t.data._new_rel_data && e.push("card-new-rel");
                    t.data.to_add && e.push("card-to-add");
                    return e;
                })(n).join(" ")}" data-id="${n.data.id}" style="transform: translate(-50%, -50%); pointer-events: auto;">\n      ${
                    t.mini_tree
                        ? (function (e) {
                              return t.mini_tree ? (e.data.to_add || e.data._new_rel_data || e.all_rels_displayed ? "" : `<div class="mini-tree">${tt()}</div>`) : "";
                          })(n)
                        : ""
                }\n      ${e(n)}\n    </div>\n    `),
                    this.querySelector(".card").addEventListener("click", (e) => t.onCardClick(e, n)),
            ...
            function l() {
                ...
                return t.card_dim.img_w || t.card_dim.img_h || t.card_dim.img_x || t.card_dim.img_y
                    ? ((e += `width: ${t.card_dim.img_w}px; height: ${t.card_dim.img_h}px;`), (e += `left: ${t.card_dim.img_x}px; top: ${t.card_dim.img_y}px;`), (e += '"'), e)
                    : "";
            }
            function c(t) {
    ...
    function mt(t, e) {
        return (
            ...
            (this.card_display = [(t) => `${t.data["first name"]} ${t.data["last name"]}`]),
            (this.mini_tree = !0),
            (this.link_break = !1),
    ...
    (ht.prototype.activate = function (t) {
        ...
        const n = (function (t, e, n) {
            ...
            if (!t.rels.father) {
                const e = f({ data: { gender: "M" }, rels: { children: [t.id] } });
                (e._new_rel_data = { rel_type: "father", label: n.father }), (t.rels.father = e.id), r.push(e);
            }
            if (!t.rels.mother) {
                const e = f({ data: { gender: "F" }, rels: { children: [t.id] } });
                (e._new_rel_data = { rel_type: "mother", label: n.mother }), (t.rels.mother = e.id), r.push(e);
            }
            ...
            if (t.rels.children) {
                ...
                t.rels.children.forEach((i) => {
                    ...
                    a.rels.mother ||
                        (e || (e = f({ data: { gender: "F" }, rels: { spouses: [t.id], children: [] } })),
                        (e._new_rel_data = { rel_type: "spouse", label: n.spouse }),
                        e.rels.children.push(a.id),
                        t.rels.spouses.push(e.id),
                        (a.rels.mother = e.id),
                        r.push(e)),
                        a.rels.father ||
                            (e || (e = f({ data: { gender: "M" }, rels: { spouses: [t.id], children: [] } })),
                            (e._new_rel_data = { rel_type: "spouse", label: n.spouse }),
                            e.rels.children.push(a.id),
                            t.rels.spouses.push(e.id),
                            (a.rels.father = e.id),
            ...
            (s._new_rel_data = { rel_type: "spouse", label: n.spouse }), t.rels.spouses.push(s.id), r.push(s), t.rels.children || (t.rels.children = []);
            return (
                t.rels.spouses.forEach((e) => {
                    ...
                    const a = f({ data: { gender: "M" }, rels: { father: t.id, mother: i.id } });
                    (a._new_rel_data = { rel_type: "son", label: n.son, other_parent_id: i.id }), i.rels.children.push(a.id), t.rels.children.push(a.id), r.push(a);
                    const s = f({ data: { gender: "F" }, rels: { mother: i.id, father: t.id } });
                    (s._new_rel_data = { rel_type: "daughter", label: n.daughter, other_parent_id: i.id }), i.rels.children.push(s.id), t.rels.children.push(s.id), r.push(s);
                }),
                r
            );
        ...
        e.updateData(n),
            ...
            (this.onChange = function (t) {
                if (t?._new_rel_data) {
                    const e = t;
                    p({ datum: this.datum, new_rel_datum: e, data_stash: this.getStoreData() }), this.onSubmitCallback(this.datum, e);
        ...
        (ht.prototype.addRelLabelsDefault = function () {
            return { father: "Add Father", mother: "Add Mother", spouse: "Add Spouse", son: "Add Son", daughter: "Add Daughter" };
        }),
            ...
            return (
                (this.history = vt.handlers.createHistory(
                    ...
                    function () {
                        ...
                        this.store.updateTree({ initial: !1 }), this.history.controls.updateButtons(), this.openFormWithId(this.store.getMainDatum()?.id);
                    }.bind(this)
                )),
                (this.history.controls = vt.handlers.createHistoryControls(this.cont, this.history)),
        ...
        (pt.prototype.init = function (t, e) {
            ...
            (this.svg = vt.createSvg(t, {
                ...
                (this.store = vt.createStore({ data: e, node_separation: this.node_separation, level_separation: this.level_separation, single_parent_empty_card: this.single_parent_empty_card, is_horizontal: this.is_horizontal })),
                this.setCard(vt.CardSvg),
                this.store.setOnUpdate((e) => {
                    this.beforeUpdate && this.beforeUpdate(e),
                        (e = Object.assign({ transition_time: this.transition_time }, e || {})),
                        this.is_card_html && (e = Object.assign({}, e || {}, { cardHtml: t.querySelector("#htmlSvg") })),
                        vt.view(this.store.getTree(), this.svg, this.getCard(), e || {}),
        ...
        (pt.prototype.setSingleParentEmptyCard = function (t, { label: e = "Unknown" } = {}) {
            return (
                ...
                this.editTreeInstance && this.editTreeInstance.addRelativeInstance.is_active && this.editTreeInstance.addRelativeInstance.onCancel(),
        ...
        (pt.prototype.setCard = function (t) {
            (this.is_card_html = t.is_html),
                this.is_card_html
                    ? ((this.svg.querySelector(".cards_view").innerHTML = ""), (this.cont.querySelector("#htmlSvg").style.display = "block"))
                    : ((this.cont.querySelector("#htmlSvg .cards_view").innerHTML = ""), (this.cont.querySelector("#htmlSvg").style.display = "none"));
            ...
            return (
                s.forEach((t) => {
                    ...
                    r.select(t.node.querySelector("div.card-inner"))
                        ...
                        .duration(0)
                        .delay(n)
                        .on("end", () => this.to_transition === e.data.id && r.select(t.node.querySelector("div.card-inner")).classed("f3-path-to-main", !0));
                }),
                o.forEach((t) => {
                    ...
                    r.select(t.node)
                        ...
                        .duration(0)
                        .delay(n)
                        .on("end", () => this.to_transition === e.data.id && r.select(t.node).classed("f3-path-to-main", !0));
                }),
                this
            );
        }),
        (gt.prototype.onLeavePathToMain = function (t, e) {
            return (
                ...
                r.select(this.cont).select("div.cards_view").selectAll("div.card-inner").classed("f3-path-to-main", !1),
                r.select(this.cont).select("svg.main_svg .links_view").selectAll(".link").classed("f3-path-to-main", !1),
                this
            );
        });
    var vt = {
        ...
        createStore: function (t) {
            ...
            return (
                (n.main_id_history = []),
                {
                    state: n,
                    updateTree: (t) => {
                        (n.tree = v({ data: n.data, main_id: n.main_id, node_separation: n.node_separation, level_separation: n.level_separation, single_parent_empty_card: n.single_parent_empty_card, is_horizontal: n.is_horizontal })),
        ...
        view: function (t, e, n, i = {}) {
            (i.initial = i.hasOwnProperty("initial") ? i.initial : !r.select(e.parentNode).select(".card_cont").node()),
                (i.transition_time = i.hasOwnProperty("transition_time") ? i.transition_time : 2e3),
                i.cardComponent
                    ? (function (t, e, n, i = {}) {
                          const s = r
                                  .select(L(() => t))
                ...
                (function (t, e, n = {}) {
                    const i = e.data.reduce((t, n) => ($({ d: n, tree: e.data, is_horizontal: e.is_horizontal }).forEach((e) => (t[e.id] = e)), t), {}),
                        a = Object.values(i),
                        s = r
                            .select(t)
                            .select(".links_view")
            ...
            return (
                i.initial
                    ? b({ svg: e, svg_dim: e.getBoundingClientRect(), tree_dim: t.dim, transition_time: 0 })
                    : "fit" === s
                    ? b({ svg: e, svg_dim: e.getBoundingClientRect(), tree_dim: t.dim, transition_time: i.transition_time })
                    : "main_to_middle" === s && w({ datum: t.data[0], svg: e, svg_dim: e.getBoundingClientRect(), scale: i.scale, transition_time: i.transition_time }),
                !0
            );
        },
